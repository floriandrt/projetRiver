...
enum CAIR_convolution { PREWITT = 0, V1 = 1, V_SQUARE = 2, SOBEL = 3, LAPLACIAN = 4, LAPLACIAN_LOG = 5, GAUSSIAN = 6 };
enum CAIR_energy { BACKWARD = 0, FORWARD = 1 };
void CAIR_Data(CML_color * Source, CML_int * S_Weights, CML_int *D_Weigths, int goal, bool changeY, CAIR_convolution conv, CAIR_energy ener, Tree<Data>& t, QImage *energyImg, int **min);
